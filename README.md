...
Key Features Processed: Title, Review Text, Clothing Categories.

Target Focus: Merging user feedback text fields into unified document-level semantic representations (paper_text).
...
Approach 2 (Custom Pattern Fashion-NER): Employs an exact boundary regex dictionary engine built to immediately pull out retail-specific features across three main categories:

Fabric: Cotton, Linen, Silk, Denim, Blend...

Size & Style: Petite, Oversized, Medium, Loose, Long...

Categories: Dress, Top, Shorts, Jacket, Shirt, Jeans...
